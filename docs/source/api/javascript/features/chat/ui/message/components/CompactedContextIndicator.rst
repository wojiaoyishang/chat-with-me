...
.. CWM-AST-FUNCTION src/features/chat/ui/message/components/CompactedContextIndicator.jsx:178:533:FUNCTION

.. rubric:: ``memo callback @ 5``

.. code-block:: javascript

   memo callback @ 5({ conversationId, messageId, replacementId = null, label = '已压缩', className = '', })
