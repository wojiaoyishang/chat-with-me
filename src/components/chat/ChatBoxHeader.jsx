                        ...
                        <div className="flex items-center justify-between w-full">
                            <div className="flex-1">
                                <Transition
                                    ...
                                    leaveTo="opacity-0"
                                >
                                    <div className="px-3 py-1.5 text-xs font-semibold bg-gray-100 text-gray-600 rounded-full whitespace-nowrap">
                                        {t(tipMessage)}
                                    </div>
                                </Transition>
                            </div>
                            <div>
                                <Transition
                                    ...
                                    leaveTo="opacity-0"
                                >
                                    <div className="px-3 py-1.5 text-xs font-medium bg-blue-100 text-blue-800 rounded-full whitespace-nowrap">
                                        {t('只读')}
                                    </div>
                                </Transition>
                            </div>
