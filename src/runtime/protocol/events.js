...
export const EventName = Object.freeze({
    ...
    EXECUTION_GUIDANCE_ADD: 'execution.guidance.add',
    ...
    VOICE_SESSION_STOP: 'voice.session.stop',
    VOICE_SESSION_ENDED: 'voice.session.ended',
    VOICE_SESSION_ERROR: 'voice.session.error',
    VOICE_PROTOCOL_CHANGED: 'voice.protocol.changed',
    VOICE_INPUT_AUDIO: 'voice.input.audio',
    VOICE_INPUT_COMMIT: 'voice.input.commit',
    VOICE_INPUT_SPEECH_STARTED: 'voice.input.speech_started',
    VOICE_INPUT_SPEECH_ENDED: 'voice.input.speech_ended',
    VOICE_TRANSCRIPT_PARTIAL: 'voice.transcript.partial',
    VOICE_TRANSCRIPT_FINAL: 'voice.transcript.final',
    VOICE_TURN_COMMITTED: 'voice.turn.committed',
    VOICE_BARGE_IN_CANDIDATE: 'voice.barge_in.candidate',
    VOICE_BARGE_IN_CONFIRMED: 'voice.barge_in.confirmed',
    VOICE_BARGE_IN_REJECTED: 'voice.barge_in.rejected',
